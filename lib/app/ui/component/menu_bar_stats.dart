...
class MenuBarStats extends StatefulWidget {
  const MenuBarStats({super.key});

  @override
  State<MenuBarStats> createState() => _MenuBarState();
}

class _MenuBarState extends State<MenuBarStats> {
  @override
          ...
          return Stack(
            children: [
              ...
              Positioned(
                ...
                left:
                    (screenWidth / 2) - 5, // Adjust the position of the circle
                child: Container(
                  width: 11,
                  height: 11,
